...
export interface Dictionary {
  ...
  analytics: {
    ...
    noDataDescription: string;
    selectSurvey: string;
    surveyAnalytics: string;
    surveyAnalyticsDescription: string;
    recompute: string;
    recomputing: string;
    recomputeHint: string;
    anonymousSurvey: string;
    anonymousHint: string;
    segmentByOrgUnit: string;
    segmentByOrgUnitDescription: string;
    noSegments: string;
    noSegmentsDescription: string;
    benchmarks: string;
    benchmarksDescription: string;
    benchmarkComparisons: string;
    benchmarkComparisonsDescription: string;
    noBenchmarks: string;
    ...
    metricResponseRate: string;
    metricAverageRating: string;
    /** روند. */
    periodDay: string;
    periodWeek: string;
    periodMonth: string;
    ...
    windowTo: string;
    computedAt: string;
    promoterPassiveDetractor: string;
  };
  responses: {
    title: string;
    description: string;
